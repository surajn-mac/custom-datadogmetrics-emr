...
def ssh_and_update_cron(list_ips, cluster_id):
    ...
    for i in list_ips:
        ...
        ssh_cron_command = ('ssh ec2-user@' + i + ' "sudo bash -c \'touch /etc/cron.d/datadog-metrics; '
                            + 'mkdir -p /var/log/datadog-custom-metrics/; '
                            + 'echo \\\"* * * * * root cd /efs/users/datadog_agent/; '
